...
sudo_users = {SUDO,1614314857,1818846445,}   
...
var = true  
elseif tonumber(user_id) == tonumber(1818846445) then
var = true  
...
if text == '𝙲𝚑𝚊𝚗𝚎𝚎𝚕 𝙰𝚍𝚛𝚢𝚊𝚗 ✅' and DevSoFi(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
...
{{text = '𝙲𝚑𝚊𝚗𝚎𝚎𝚕 𝙰𝚍𝚛𝚢𝚊𝚗 ✅️️', url="t.me/Source_AdrYan"}}, 
} 
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'مطور السورس⚙',url="t.me/AhmedAdryan"}},
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝙰𝚍𝚛𝚢𝚊𝚗 ➪ ',url="t.me/AhmedAdryan"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
if tonumber(result.sender_user_id_) == tonumber(1818846445) then  
...
if result.id_ == tonumber(1818846445) then
...
if tonumber(userid) == tonumber(1818846445) then  
send(msg.chat_id_, msg.id_, " 𖡃 لا تسطيع حظر مبرمج السورس عام")
return false 
end
