...
sudo_users = {SUDO,1398830949,1614314857,1818846445,}   
...
if text == '𝐒𝐨𝐮𝐫𝐜𝐞 𝐀𝐝𝐫𝐲𝐚𝐧' and DevSoFi(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
...
{{text = '𝐒𝐨𝐮𝐫𝐜𝐞 𝐀𝐝𝐫𝐲𝐚𝐧️️', url="t.me/Source_AdrYan"}}, 
} 
