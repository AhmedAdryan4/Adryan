...
if res ~= 200 then
print('\27[0;31m•══━━━━ 𝐀𝐃𝐑𝐘𝐀𝐍━━━━══•\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \na•══━━━━ 𝐀𝐃𝐑𝐘𝐀𝐍━━━━══•\n27[0;39;49m')
database:set(id_server..":token",token)
end 
else
print('\27[0;35m•══━━━━ 𝐀𝐃𝐑𝐘𝐀𝐍━━━━══• ┉\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼 𝐒𝐎𝐔𝐑𝐂𝐄  𝐀𝐃𝐑𝐘𝐀𝐍")  
...
if text == '𝐒𝐎𝐔𝐑𝐂𝐄  𝐀𝐃𝐑𝐘𝐀𝐍' and DevSoFi(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
...
{{text = '𝐒𝐎𝐔𝐑𝐂𝐄  𝐀𝐃𝐑𝐘𝐀𝐍️️', url="t.me/Source_AdrYan"}}, 
} 
...
{{text = '𝐒𝐎𝐔𝐑𝐂𝐄  𝐀𝐃𝐑𝐘𝐀𝐍 🧭 ', url="t.me/Source_AdrYan"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
' }\n'..' 𖡃  الرفع ⇐ { '..setadd..
' }\n'..' 𖡃  الحظر ⇐ { '..banm..' }\n\n•══━━━━ 𝐀𝐃𝐑𝐘𝐀𝐍━━━━══•\n 𖡃 قناة سورس ادريان ↓\n [ 𝐒𝐎𝐔𝐑𝐂𝐄  𝐀𝐃𝐑𝐘𝐀𝐍](t.me/Source_AdrYan) \n'
send(msg.chat_id_, msg.id_,text)     
end
